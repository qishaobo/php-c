...
#define PHP_SHOP_VERSION "0.1.0" /* Replace with version number for your extension */

#ifdef PHP_WIN32
#	define PHP_SHOP_API __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
#	define PHP_SHOP_API __attribute__ ((visibility("default")))
#else
#	define PHP_SHOP_API
#endif
...
/* In every utility function you add that needs to use variables 
   ...
   the globals in your function as SHOP_G(variable).  You are 
